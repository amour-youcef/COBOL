 +     identification division.
       program-id. "ENHANCEDBMICALCILATOR".
       author. youssouf.
      * is program reads input from the user
       ...
       01  HEADING-LINE.
           ...
           05    FILLER         PIC   X(30) VALUE 'WEIGH IN POUNDS'.
      ...
      *This is a priming read of the date file 
           READ BMI-FILE
       ...
       0200-CALCULATE-BMI.
           ...
           COMPUTE WS-BMI  = WEIGHT * 703 / (HEIGHT_INCHES * 
                                            HEIGHT_INCHES).
           
           MOVE  PERSON-NAME       TO DET-NAME .
           MOVE  HEIGHT_INCHES     TO DET-HEIGHT.
        ...
        0400-STOP-RUN.
          ...
          END PROGRAM ENHANCEDBMICALCILATOR.